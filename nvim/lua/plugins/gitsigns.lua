...
vim.keymap.set("n", "<leader>ghw", function() require('gitsigns').setqflist("all") end, {noremap = true})
-- chunks for the current buffer into location list
vim.keymap.set("n", "<leader>ghb", function() require('gitsigns').setloclist(0) end, {noremap = true})
